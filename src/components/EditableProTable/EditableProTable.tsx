...
export default class EditableProTable<T, P extends { [key: string]: any } = {}>
  ...
  private makeColumns = memoizeOne((columns: EditableProTableColumn<T>[]): EditableProTableColumn<T>[] => {
    // @ts-ignore
